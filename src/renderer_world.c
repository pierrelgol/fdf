...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/16 10:37:23 by pollivie          #+#    #+#             */
/*   Updated: 2024/06/16 10:37:24 by pollivie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool renderer_clear_world(t_renderer *const self)
{
	...
	if (!self->world_color_buffer || !self->world_coord_buffer)
		return (false);
	memory_fill(self->world_coord_buffer, 0x00, self->world_height * self->world_width * sizeof(t_vec3));
	memory_fill(self->world_color_buffer, 0x00, self->world_height * self->world_width * sizeof(int32_t));
	return (true);
}
